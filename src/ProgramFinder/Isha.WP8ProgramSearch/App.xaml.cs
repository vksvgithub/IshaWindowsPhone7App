...
namespace ProgramSearch
{
    public partial class App : Application
    {
        ...
        private static ProgramDetailModel selectedProgram = null;

        /// <summary>
        /// A static ViewModel used by the views to bind against.
        /// </summary>
        /// <returns>The ProgramListModel object.</returns>
        public static ProgramListModel RequestedProgramListModel
        {
            get
            {
        ...
        public static ProgramDetailModel SelectedProgramDetailModel
        {
            get
            {
